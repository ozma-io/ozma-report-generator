...
namespace ReportGenerator.Controllers
{
    ...
    public class GenerateController : BaseController
    {
        ...
        private async Task<IActionResult?> GenerateTemplate(string instanceName, string schemaName, string templateName, string fileName, string format)
        {
            ...
            var ozmaDbApiConnector = new OzmaDBApi.OzmaDBApiConnector(configuration, instanceName, TokenProcessor);
            var checkAccess = await ozmaDbApiConnector.CheckAccess();
            ...
            var generatedReport =
                await ReportTemplateFunctions.GenerateReport(ozmaDbApiConnector, template, paramsWithValues);
